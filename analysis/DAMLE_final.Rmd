...
ggplot() + geom_sf(data=census_tract_race, aes(fill= percent_black), color=NA) +  
  labs(title="Congressional District 6 in 2022", 
       fill="Percentage Black population", 
       subtitle="The 2022 congressional maps preserve the Triad to mostly one district. 
...
The new maps show signs of the gerrymandering practice, cracking, where minority votes are split between districts to weaken their power. The new district also leans Republican with 14 percent more voters in the choosing Trump in 2020, than in the old district. This shift has led current Democratic representative, Kathy Manning, not to seek re-election. 

To be sure, the NC General Assembly said they did not use racial data to draw the district lines. Districts 1, 12 and 14 are also challenged in lawsuits. 

**Pitch memo**

Redistricting is a topic that comes up again and again in North Carolina, however, there is much to explore regarding the new 2023 congressional maps. Although many stories have been written about the issue already, not many stories out there focus on the local impact of redistricting. My story would take a local angle looking just at District 6 in NC, and how voters in the area feel about these changes. The story is timely with the upcoming 2024 elections and covers an issue in North Carolina that limits democracy in the state. Additionally, these districts in North Carolina could determine who wins control of the House in the fall, so there is a national relevance to this local story. The data for this story is nearly all publicly available online. I believe with more time and analysis, I could determine more specifically which communities in the Triad region would be impacted by redistricting.
...
In my pitch I focus on District 6, due to the large differences in partisanship and racial makeup I found between the 2022 and 2024 District.
